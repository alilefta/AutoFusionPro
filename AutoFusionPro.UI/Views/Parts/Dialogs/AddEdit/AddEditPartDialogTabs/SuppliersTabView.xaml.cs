...
namespace AutoFusionPro.UI.Views.Parts.Dialogs.AddEdit.AddEditPartDialogTabs
{
    /// <summary>
    /// Interaction logic for SuppliersTabView.xaml
    /// </summary>
    public partial class SuppliersTabView : UserControl
    {
        public SuppliersTabView()
        {
            InitializeComponent();
        }
    }
