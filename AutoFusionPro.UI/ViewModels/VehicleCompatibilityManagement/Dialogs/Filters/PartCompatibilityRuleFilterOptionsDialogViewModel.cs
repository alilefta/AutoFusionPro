...
{
    public partial class PartCompatibilityRuleFilterOptionsDialogViewModel : InitializableViewModel<PartCompatibilityRuleFilterOptionsDialogViewModel>, IDialogViewModelWithResult<RuleFilterCriteriaDto>
    {
        ...
        [NotifyPropertyChangedFor(nameof(AnyFilterSelected))]
        private bool _showOnlyTemplates = false;


        private RuleFilterCriteriaDto? _resultFilters;
        ...
        public bool IsShowOnlyTemplatesApplied => ShowOnlyTemplates == true;

        public bool AnyFilterSelected => IsMakeModelTrimFilterActive || IsTransmissionTypeSelected || IsEngineTypeSelected || IsBodyTypeSelected || IsExactYearSelected || IsShowByActivityNotDefault || IsShowOnlyTemplatesApplied;
        ...
        private void PopulateShowByActivityCombobox()
        {
            ...
            var showOnlyActiveRulesStr = GetString("ShowOnlyActiveRulesStr");
            ...
            ShowRulesByActivityFilterDtos.Add(showOnlyInactiveRulesItem);
        ...
        private void ApplyFilters()
        {
            try
            {
                ...
                _resultFilters = new RuleFilterCriteriaDto(
                    SearchTerm: null,
                    PartId: null,
                    ...
                    ShowActiveOnly: SelectedShowByActivityItem?.value ?? null,
                    ShowTemplatesOnly: ShowOnlyTemplates
        ...
        public void SetDialogWindow(IDialogWindow dialog)
        {
            if (dialog == null)
            {
                _logger.LogError("The Dialog window was null on {VM}", nameof(PartCompatibilityRuleFilterOptionsDialog));
                return;
            }
        ...
        public RuleFilterCriteriaDto? GetResult()
        {
