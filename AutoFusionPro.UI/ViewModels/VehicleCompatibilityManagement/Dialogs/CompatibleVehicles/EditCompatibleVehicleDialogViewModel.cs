...
namespace AutoFusionPro.UI.ViewModels.VehicleCompatibilityManagement.Dialogs.CompatibleVehicles
{
    public partial class EditCompatibleVehicleDialogViewModel : InitializableViewModel<EditCompatibleVehicleDialogViewModel>, IDialogAware
    {
        ...
        public EditCompatibleVehicleDialogViewModel(ICompatibleVehicleService compatibleVehicleService, ILocalizationService localizationService, ILogger<EditCompatibleVehicleDialogViewModel> logger) : base(localizationService, logger)
        {
