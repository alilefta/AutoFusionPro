...
{
    public class VehicleRepository_OLD : Repository<Vehicle, VehicleRepository_OLD>, IVehicleRepository_OLD
    {
        public VehicleRepository_OLD(ApplicationDbContext context, ILogger<VehicleRepository_OLD> logger) : base(context, logger)
        {
        }
