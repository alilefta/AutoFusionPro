...
namespace AutoFusionPro.Infrastructure.Migrations
{
    ...
    [Migration("20250523095201_Add placeholder Logo for makes and models")]
    partial class AddplaceholderLogoformakesandmodels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoFusionPro.Domain.Models.CompatibleVehicleModels.BodyType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(662),
                            Name = "Sedan"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(666),
                            Name = "SUV (Sport Utility Vehicle)"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(668),
                            Name = "Hatchback"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(671),
                            Name = "Coupe"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(673),
                            Name = "Convertible"
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(675),
                            Name = "Minivan"
                        },
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(677),
                            Name = "Truck (Pickup)"
                        },
                        new
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(679),
                            Name = "Wagon (Estate)"
                        });
                });
            ...
            modelBuilder.Entity("AutoFusionPro.Domain.Models.CompatibleVehicleModels.EngineType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "I4_GAS",
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(730),
                        ...
                        new
                        {
                            Id = 2,
                            Code = "V6_GAS",
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(744),
                            Name = "Gasoline - V6"
                        },
                        new
                        {
                            Id = 3,
                            Code = "I4_DSL",
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(747),
                        ...
                        new
                        {
                            Id = 4,
                            Code = "ELEC",
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(750),
                            Name = "Electric"
                        },
                        new
                        {
                            Id = 5,
                            Code = "HYB",
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(753),
                            Name = "Hybrid"
                        });
                });
            ...
            modelBuilder.Entity("AutoFusionPro.Domain.Models.CompatibleVehicleModels.TransmissionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(400),
                            Name = "Automatic"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(413),
                            Name = "Manual"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(416),
                            Name = "CVT (Continuously Variable Transmission)"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(418),
                            Name = "Semi-Automatic"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 5, 23, 9, 51, 59, 579, DateTimeKind.Utc).AddTicks(421),
