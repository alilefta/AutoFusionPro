...
{
    public class UpdateTrimLevelDtoValidator : AbstractValidator<UpdateTrimLevelDto>
    {
        public UpdateTrimLevelDtoValidator(IUnitOfWork unitOfWork)
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("Invalid Trim Level ID.");
